...
//this will create aws key-pair for ec2
resource "aws_key_pair" "ec2ServerKey" {
    key_name = "Keypair-workshop"
    public_key = tls_private_key.key.public_key_openssh
}


// We can also store this key offline for future use
// On destroy this file will also be deleted automatocally
resource "local_file" "web_key" {
    content = tls_private_key.key.private_key_pem
    filename = "Keypair-workshop.pem"
}
